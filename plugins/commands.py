...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('📢 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 📢', url=f'https://t.me/itz_showtime')
            ],[
            InlineKeyboardButton('😇 movie search group 😇', url='https://t.me/+2O3oGTtM1dllOWY1')
            ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("📢 GROUP 📢", url="https://t.me/+2O3oGTtM1dllOWY1")
            ],[
            InlineKeyboardButton("🔍 𝚂𝙴𝙰𝚁𝙲𝙷 🔍", callback_data="search")
            ],[
